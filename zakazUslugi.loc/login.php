                ...
                <div class="col-lg-5">
                    <form id="login-form" action="login.php" method="post">
                        ...
                        <div class="mb-3 field-loginform-login required">
                            ...
                            <!-- ВозвращаемLoginForm[login], чтобы метод load в Entity.php не ругался -->
                            <input type="text" id="loginform-login" class="col-lg-3 form-control"
                                name="LoginForm[login]" autofocus aria-required="true" 
                                value="<?= isset($_POST['LoginForm']['login']) ? htmlspecialchars($_POST['LoginForm']['login']) : '' ?>">
                        ...
                        <div class="mb-3 field-loginform-password required">
                            ...
                            <!-- Возвращаем LoginForm[password], убирая ошибку "Undefined array key" -->
